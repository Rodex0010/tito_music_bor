...
## 📦 tito/ - Main Application Package

The core bot application containing all functionality.

### 🔧 tito/core/ - Core Components
...
### 🛠️ tito/helpers/ - Helper Functions
...
### 📦 tito/**init**.py - Package Initialization

Initializes and exports core components:

```python
from tito.core import app, userbot, tune, db, yt, logger
from tito import config
```
...
```python
from tito import app, userbot, tune, db, config, logger
```

**Helper imports:**

```python
from tito.helpers import buttons, thumb, utils
from tito.helpers import is_admin, Queue, Track
```
