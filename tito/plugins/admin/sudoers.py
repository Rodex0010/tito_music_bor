...
@app.on_message(filters.command(["اضافة_مشرف", "حذف_مشرف", "ازالة_مشرف", "addsudo", "delsudo", "removesudo"], prefixes=["", "/"]) & app.sudo_filter)
@lang.language()
...
@app.on_message(filters.command(["قائمة_المشرفين", "المشرفين", "sudolist", "sudoers"], prefixes=["", "/"]) & app.sudo_filter)
@lang.language()
